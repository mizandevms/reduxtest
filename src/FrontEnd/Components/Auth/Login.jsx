...
import login from "../../../images/undraw_sign_in_re_o58h.svg"
	...
	return (
		<section className='flex flex-col justify-center items-center h-full w-full'>
			<div className='flex  justify-center space-x-3 items-center py-4'>
				<img className='h-32 w-auto' src={login} alt='img' />
			...
			<div className='w-full'>
				<form onSubmit={handleSubmit(onSubmit)} className='max-w-xl mx-auto border border-gray-200 rounded-md shadow py-4 px-8'>
					<div className='flex flex-col justify-center items-center gap-1 py-2 w-full space-y-2'>
						...
						<input type='submit' value='Login' className='border border-gray-200 px-4 py-2 w-1/3 mx-auto cursor-pointer rounded-md  shadow-sm bg-cyan-700  text-gray-50 hover:border-cyan-500 hover:bg-gray-100 hover:text-cyan-700 font-semibold text-sm' />
